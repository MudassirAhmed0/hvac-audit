---
title: "How Much Should an HVAC Company Spend on Marketing? A Data-Driven Breakdown"
...
Google Ads works when your website converts. If your site [takes 18.4 seconds to load](/blog/18-seconds-your-customer-left-after-3/) and has no click-to-call button, you're paying $50 per click to send people to a dead end.
...
1. **Use dedicated landing pages** — not your homepage. A [landing page built for each service/city combination](/blog/hvac-landing-page-playbook/) converts 3-5x better than a homepage. Same spend, 3-5x more leads.

2. **Set negative keywords** — block searches like "HVAC jobs," "HVAC training," "DIY AC repair," and "how to fix AC myself." These clicks cost $30-$50 each and produce zero customers.

3. **Bid on emergency keywords** — "emergency AC repair [city]" has the highest close rate of any HVAC keyword (85-95%). These searchers aren't shopping — they're buying. Pay more per click because the conversion rate justifies it.

4. **Daypart your ads** — analyze when your calls come in. If 40% of calls happen between 12pm-6pm, allocate more budget to those hours. Reduce spend during hours with low call volume.

5. **Track everything** — use [call tracking](/blog/hvac-call-tracking-setup/) to attribute every call to a specific keyword and ad group. Without this, you're optimizing blind.
...
SEO is the cheapest lead source in the long run but requires patience. The contractors who invest in [proper service pages, GBP optimization](/blog/hvac-google-business-profile/), and consistent content see their cost per lead drop every month as rankings improve.
...
- Delivered by [an agency that hits any red flags](/blog/hvac-marketing-agency-red-flags/).
...
The math: at $50/lead and a 10% close rate, you're paying $500 to acquire one customer. Compare that to a well-optimized website pulling organic leads at $15 each with a 25% close rate — that's $60 per customer. An [8x difference in customer acquisition cost](/blog/best-lead-source-hvac/).
...
- During [shoulder seasons](/blog/hvac-off-season-marketing/) to fill gaps
...
Your [Google Business Profile](/blog/hvac-google-business-profile/) is free and potentially your most valuable marketing asset. When optimized and actively managed, it generates calls without any ad spend.
...
Old school but still works in specific situations. Best paired with digital — someone gets a door hanger, Googles your name, and finds a solid website. The [website is where the conversion happens](/blog/hvac-website-not-getting-calls/).
...
The exact split depends on your market. In hyper-competitive cities like [Dallas or Houston](/blog/hvac-seo-texas/), you might need 50% on ads to stay visible. In smaller markets, SEO alone can dominate.
...
If you're spending $5,000/month and you have no idea how many customers you acquired, you're [flying blind](/blog/hvac-call-tracking-setup/).

**How to calculate cost per acquired customer:**

1. Set up [call tracking](/blog/hvac-call-tracking-setup/) for each marketing channel
2. Tag each lead with its source in your CRM
3. Track which leads become booked jobs
4. Divide total marketing spend by total new customers acquired
...
- You're in [shoulder season](/blog/hvac-off-season-marketing/) and demand naturally dips (reduce ads but maintain SEO)
