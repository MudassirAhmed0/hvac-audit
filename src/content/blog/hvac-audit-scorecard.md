---
title: "The HVAC Website Scorecard: 15 Things We Check on Every Audit"
description: "Here's exactly how we score HVAC websites — every category, every weight, every threshold. The methodology behind the 34/100 average that's costing contractors leads."
date: 2026-03-08
readTime: "10 min read"
cover: "/blog/cover-audit-scorecard.webp"
---
...
**When we audited [147 HVAC websites](/blog/hvac-website-audit-147-sites/), the average score was 34 out of 100.** Not because these are bad businesses — most have great reviews, years of experience, and loyal customers. But their websites fail at the specific things that convert visitors into phone calls. This post breaks down exactly what we check, how we weight it, and why each factor matters.
...
<figure>
<svg viewBox="0 0 560 380" style="max-width: 100%; height: auto; font-family: 'Geist', system-ui, sans-serif" role="img" aria-label="Donut chart showing score distribution: 3% score 80+, 11% score 50-79, 44% score 25-49, 42% score below 25">
  ...
  <g transform="translate(200, 200)">
    ...
    <circle cx="0" cy="0" r="110" fill="none" stroke="#0ea5e9" stroke-width="38"
            stroke-dasharray="76.1 615" stroke-dashoffset="-20.7" transform="rotate(-90)"/>
    <circle cx="0" cy="0" r="110" fill="none" stroke="#eab308" stroke-width="38"
            stroke-dasharray="304.2 386.9" stroke-dashoffset="-96.8" transform="rotate(-90)"/>
    <circle cx="0" cy="0" r="110" fill="none" stroke="#ef4444" stroke-width="38"
            stroke-dasharray="290.4 400.7" stroke-dashoffset="-401" transform="rotate(-90)"/>
  ...
  <g transform="translate(370, 120)">
    ...
    <rect x="0" y="24" width="10" height="10" rx="2" fill="#0ea5e9"/>
    <text x="16" y="34" font-size="11" fill="currentColor">50–79 — 11%</text>
    <rect x="0" y="48" width="10" height="10" rx="2" fill="#eab308"/>
    <text x="16" y="58" font-size="11" fill="currentColor">25–49 — 44%</text>
...
**44% of HVAC websites hide the phone number below the fold or behind a "Contact Us" link.** Every extra tap between the visitor and the call is a lost lead. The [sites that score in the top 5%](/blog/top-5-percent-hvac-websites/) all have the phone number visible within the first second of page load.
...
A "Not Secure" warning on your website tells the homeowner that entering their phone number or address might not be safe. [The audit data shows](/blog/hvac-audit-50-vs-90/) that sites without SSL convert at less than half the rate of secured sites — the trust signal is that powerful.
...
The [difference between a 50-score and 90-score website](/blog/hvac-audit-50-vs-90/) often comes down to whether social proof is visible on the site itself, not just on external platforms.
...
<figure>
<svg viewBox="0 0 560 380" style="max-width: 100%; height: auto; font-family: 'Geist', system-ui, sans-serif" role="img" aria-label="Horizontal stacked bar chart showing the weight of each scoring category with failure rates">
  <title>Scoring Category Weights and Failure Rates</title>
...
**80-100 (top 3%):** These sites generate **5-8 leads per week** from organic traffic alone. They load fast, convert well, and rank for local searches. [These are the top 5%](/blog/top-5-percent-hvac-websites/) — and they're pulling away from everyone else.
...
**The [cost of a low-scoring website](/blog/hvac-website-costing-4200-per-month/) is roughly $4,200 per month in missed leads.** That's $50,400 per year — more than enough to fund a complete website rebuild and ongoing optimization.
...
We also built an [audit from the homeowner's viewpoint](/blog/hvac-audit-homeowner-view/) — what the customer actually experiences when they land on your site. The scorecard measures technical performance. The homeowner audit measures emotional response.
...
When [your score is 34 and your competitor scores 91](/blog/your-score-34-competitor-91/), the homeowner comparing your websites makes a gut decision in under 5 seconds. The faster, more professional, more trustworthy-looking site wins. Every time.
...
**The average HVAC website [costs its owner $4,200 per month](/blog/hvac-website-costing-4200-per-month/) in missed leads.** A score of 34 isn't just a number — it's a monthly invoice for invisible losses. Moving from 34 to 65 doesn't require a $50,000 redesign. It requires fixing the 5-7 specific issues that drag your score down.
...
- [From 50 to 90: What Changes When an HVAC Website Actually Gets Fixed](/blog/hvac-audit-50-vs-90/)
- [What the Top 5% of HVAC Websites Do That Yours Doesn't](/blog/top-5-percent-hvac-websites/)
