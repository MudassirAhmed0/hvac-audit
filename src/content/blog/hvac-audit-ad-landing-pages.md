...
date: 2026-03-08
readTime: "9 min read"
cover: "/blog/cover-audit-landing-pages.webp"
---
...
The contractors in our audit who displayed pricing on their landing pages converted at **11.2% — more than triple the 3.4% average** of those who hid pricing entirely. The [pricing transparency data](/blog/hvac-pricing-transparency/) is unambiguous: showing prices doesn't scare homeowners away. Hiding them does.
...
1. Fixed header (sticky on scroll)
2. Hero section (above the fold, large text)
3. Midpage CTA block (after the first content section)
...
<figure>
<svg viewBox="0 0 560 380" style="max-width: 100%; height: auto; font-family: 'Geist', system-ui, sans-serif" role="img" aria-label="Landing page audit results: 86% missing pricing, 76% buried phone number, 72% no trust signals above fold">
  <title>The 3 Tests Most HVAC Landing Pages Fail</title>
...
1. **Headline matching the ad copy.** If the ad says "Same-Day AC Repair in [City]," the landing page headline should say "Same-Day AC Repair in [City]" — not "Welcome to ABC Heating & Cooling." Ad-to-page message match increases conversion by **30–40%.**

2. **Phone number — sticky, large, click-to-call.** The number should be visible on every scroll position. On mobile, a fixed-bottom call bar produces the most clicks.

3. **Pricing range above the fold.** "$89 diagnostic, waived with repair. Most repairs $250–$600." Two sentences that eliminate price anxiety.

4. **Trust signals.** Star rating, review count, licensing, insurance, years in business. All visible without scrolling.

5. **One form (max 4 fields).** Name, phone, ZIP, problem description. Every additional field reduces form completion by **10–15%.** Seven-field forms convert at half the rate of four-field forms.

6. **No navigation menu.** Remove the menu entirely. The visitor has one path: convert or leave. Navigation gives them a third option — browse — which means they don't convert on this page.

The [landing page playbook](/blog/hvac-landing-page-playbook/) covers this in detail, but the core principle is ruthless simplicity. Every element that doesn't drive toward a phone call or form submission is costing you money.
...
<figure>
<svg viewBox="0 0 560 380" style="max-width: 100%; height: auto; font-family: 'Geist', system-ui, sans-serif" role="img" aria-label="Landing page conversion rates: homepage 2.3%, basic landing page 5.1%, optimized landing page 11.2%, passing all 3 tests plus fast load">
  <title>Conversion Rates: Homepage vs. Landing Pages</title>
  ...
  <g transform="translate(70, 70)">
    ...
    <line x1="0" y1="176" x2="420" y2="176" stroke="currentColor" stroke-opacity="0.08"/>
    <line x1="0" y1="132" x2="420" y2="132" stroke="currentColor" stroke-opacity="0.08"/>
...
- Service area list
- FAQ block (3–4 entries — without FAQPage schema since [Google restricted it](/blog/hvac-audit-homeowner-view/) in 2023)
...
Let's put numbers on the gap. Two contractors spend the same $5,000/month on [Google Ads](/blog/hvac-google-ads-waste/). Both get 400–500 clicks.

**Contractor A** sends traffic to his homepage. Conversion rate: 2.3%. Leads: 10. Cost per lead: $500. [Customer acquisition cost](/blog/hvac-website-conversion-rate/): $1,250 (at 40% close rate).
...
- [We Audited 147 HVAC Websites. What We Found Was Worse Than Expected.](/blog/hvac-audit-homeowner-view/)
